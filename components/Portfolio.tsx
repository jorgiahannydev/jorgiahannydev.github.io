  ...
  return (
    <div className="bg-white rounded-xl shadow-sm overflow-hidden hover:-translate-y-1 hover:shadow-md transition-all duration-300 flex flex-col">
      {p.img ? (
        ...
        <div className="h-44 bg-gradient-to-br from-slate-700 to-pink-500 flex items-center justify-center">
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex flex-wrap gap-1.5 mb-3">
          {p.tags.map((t) => (
            <span
              key={t}
              className="text-xs bg-pink-50 text-pink-600 border border-pink-200 px-2.5 py-0.5 rounded-full font-medium"
            >
              {t}
            </span>
          ))}
        ...
        <div className="flex gap-2 flex-wrap">
          {p.demo && (
            <a
              ...
              className="text-xs bg-pink-500 hover:bg-pink-600 text-white font-semibold px-3 py-1.5 rounded-lg transition-colors"
            >
              Ver demo
            </a>
          )}
