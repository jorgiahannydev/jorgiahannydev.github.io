      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 max-w-lg mx-auto">
          ...
          <ul className="space-y-3 mb-6 text-gray-600 text-sm">
            ...
            <li>
              📞{" "}
              <a href="tel:+56975895960" className="text-rose-500 hover:underline">
                +56 975 895 960
              </a>
            </li>
            <li>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="/cv.pdf"
              download
              className="bg-rose-500 hover:bg-rose-600 active:scale-95 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-all"
            >
              Descargar CV
            </a>
          </div>
